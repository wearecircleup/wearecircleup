        ...
        <div className="bg-n-7 border border-n-6 rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col gap-4 mt-8">
            <div className="flex gap-4">
              <button
                onClick={onEdit}
                className="flex-1 px-6 py-4 bg-gradient-to-r from-color-1 to-color-2 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-color-1/50 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                onClick={onClose}
                className="px-6 py-4 bg-n-6 hover:bg-n-5 text-n-1 rounded-xl font-semibold transition-all"
              >
                Cerrar
              </button>
            </div>
            ...
            <button
              onClick={onDelete}
              className="w-full px-6 py-4 bg-red-500/10 hover:bg-red-500/20 border-2 border-red-500/30 hover:border-red-500/50 text-red-400 hover:text-red-300 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 group"
            >
