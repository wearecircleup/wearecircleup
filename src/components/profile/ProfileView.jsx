      ...
      >
        ...
        <div className="bg-n-7 border border-n-6 rounded-2xl overflow-hidden">
          ...
          <div className="p-6 bg-n-8 border-t border-n-6 flex items-center justify-between">
            <button
              onClick={onEdit}
              className="px-6 py-3 bg-gradient-to-r from-color-1 to-color-2 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-color-1/50 transition-all"
            >
              Editar Perfil
            </button>
