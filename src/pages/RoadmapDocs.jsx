...
import {
  roadmapArticleMetaByLanguage,
  roadmapDocsContentByLanguage,
  roadmapDocsFooterCopyByLanguage,
} from "../content/roadmapDocsContent";
...
const RoadmapDocs = ({ setCurrentPage }) => {
  ...
  const articleMeta = roadmapArticleMetaByLanguage[pageLanguage];
  const allContent = roadmapDocsContentByLanguage[pageLanguage];
  ...
  return (
    <div className="relative min-h-screen bg-n-8">
      ...
      <Footer message={roadmapDocsFooterCopyByLanguage[pageLanguage]} />
    </div>
  );
};
